...
void UTP_WeaponComponent::AttachWeapon(AFPSZombieGameCharacter* TargetCharacter)
{
	...
	AttachToComponent(Character->GetMeshWithSockets(), AttachmentRules, FName(TEXT("GripPoint")));
